        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                'YOUR 4HOPE ACCOUNT'.toUpperCase(),
                style: headline20.copyWith(
                    color: Pallete.primaryColor, fontWeight: FontWeight.bold),
              ),
            ),
...
class ResumeList extends ConsumerWidget {
  ...
  final User user;
  const ResumeList(this.user, this.useMobileLayout, {Key? key})
      : super(key: key);
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      if (resumes.length >= 3) {
                        ...
                        ref
                            .watch(resumeController(user.uid).notifier)
                            .addToResume(
  ...
  Widget build(BuildContext context, ref) {
    return Container(
        ...
        decoration: BoxDecoration(
            borderRadius: Shape.roundedShapeAll(10),
            border: Border.all(
                color: Pallete.secondaryBackgroundColor, width: 1.5)),
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              SimpleOutlinedButton(
                  ...
                  onPressed: () async {
                    await ref
                        .watch(resumeController(uid).notifier)
                        .deleteFromResume(pdfModel: pdfModel);
                  },
                  text: 'Delete'),
              const SizedBox(
                width: 16,
